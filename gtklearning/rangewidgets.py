...
class RangeWidgets:
	...
	def __init__(self):
		...
		button = gtk.CheckButton("display valu on scale widgets")
		...
		opt = gtk.OptionMenu()
		menu = gtk.Menu()
		item = make_menu_item("continuous", self.cb_update_menu_select,gtk.UPDATE_CONTINUOUS)
		menu.append(item)
		item = make_menu_item("discontinous", self.cb_update_menu_select, gtk.UPDATE_DISCONTINUOUS)
		menu.append(item)
		item = make_menu_item("delayed", self.cb_update_menu_select, gtk.UPDATE_DELAYED)
		menu.append(item)
